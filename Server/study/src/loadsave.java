 ...
 */
@WebServlet("/loadsave")
public class loadsave extends HttpServlet {
		 ...
		 PrintWriter out = response.getWriter();      
			...
			try {
				...
				if(request.getParameter("type").equals("video")) {	 
					 sql="select picture,name,video from video  where name in (select videoname from videofunction  where save='true' and openid="+ "'"+request.getParameter("openid")+"'"+ ")"  ;
				...
				if(request.getParameter("type").equals("book")) {	 
					 sql="select picture,name,book from book  where name in (select bookname from bookfunction  where save='true' and openid="+ "'"+request.getParameter("openid")+"'"+ ")"  ;
